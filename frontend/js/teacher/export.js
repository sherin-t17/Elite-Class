  ...
  render(el) {
    el.innerHTML = `
      <div class="page-header">
        <div><h2 class="page-title">Export Reports</h2><p class="page-subtitle">Download attendance, grades, student performance and leaderboard data.</p></div>
      </div>
      <div class="two-col animate-in">
        <div class="card">
          <div class="card-header"><div class="card-title">PDF Reports</div></div>
          <div class="card-body" style="display:flex;flex-direction:column;gap:10px">
            <button class="export-btn pdf" onclick="EC.teacherExport.download('attendance','pdf')">Attendance Report PDF</button>
        ...
        <div class="card">
          ...
          <div class="card-body" style="display:flex;flex-direction:column;gap:10px">
            <button class="export-btn excel" onclick="EC.teacherExport.download('attendance','excel')">Attendance Excel</button>
